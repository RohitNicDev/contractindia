...
// ── Existing dashboard pages (inside DashboardLayout) ─────────────────────
...
// ── Profile wizard (inside DashboardLayout at /dashboard/profile-wizard) ──
...
export const router = createBrowserRouter([
  ...
  // ── Main dashboard (DashboardLayout sidebar) ──────────────────────────────
  // {
  //   path: "/dashboard",
  ...
  // ── Individual user dashboard (standalone) ────────────────────────────────
  { path: "/individual/dashboard",  element: <IndividualDashboard /> },

  // ── Commercial user dashboard (standalone) ────────────────────────────────
