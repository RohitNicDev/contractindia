    ...
    validFiles.forEach((file) => {
      ...
      const interval = setInterval(() => {
        ...
        store.setRegistrationDetails({
          importExportCertFiles: [...updatedFiles],
        });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] bg-white/5 px-2 py-0.5 rounded-full text-slate-400 border border-white/10 font-mono">
                  v1.4
                </span>
              </div>
              <h1 className="text-base font-extrabold  font-extrabold text-slate-800 tracking-tight ">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-300 font-semibold">
              ...
              <strong className="text-purple-400">
                {Math.max(0, Math.ceil((45 - progress) / 8))} mins
              </strong>
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 bg-white/80 backdrop-blur-xl border border-white/90 shadow-[0_2px_20px_rgba(99,102,241,0.07)] p-2 rounded-2xl">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                ...
                <span
                  className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${strength.color}`}
                >
                  {strength.label}
                </span>
              </div>
          ...
          <div className="relative flex-1">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {store.currentStep === 1 && (
                  <div className="space-y-4">
                    <p className="text-xs text-slate-500">
                      Select your organization structure. This will determine
                      registration details and tax requirements.
                    </p>
                ...
                {store.currentStep === 2 && (
                  <form
                    onSubmit={handleSubmitStep2(onSaveStep2)}
                    className="space-y-4"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100/50 text-slate-800 placeholder-slate-400 shadow-sm"
                          {...registerStep2("contactPerson", {
                            required: "Contact Person is required",
                          })}
                        />
                        {errorsStep2.contactPerson && (
                          <span className="text-red-500 text-[10px] flex items-center gap-1">
                            <AlertCircle className="w-3 h-3" />{" "}
                            {errorsStep2.contactPerson.message}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col gap-1.5 relative">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              triggerOtpSend("email", watchStep2("email"))
                            }
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              triggerOtpSend("mobile", watchStep2("mobile"))
                            }
                            className={`px-4 rounded-xl font-bold text-xs border flex items-center justify-center shrink-0 shadow-sm transition-colors ${
                ...
                {store.currentStep === 3 && (
                  <form
                    onSubmit={handleSubmitStep3(onSaveStep3)}
                    className="space-y-6"
                  >
                    ...
                    <div className="bg-slate-50/50 border border-slate-200/60 rounded-2xl p-5 space-y-4 mt-6">
                      ...
                      <div
                        ...
                        onDrop={handleDrop}
                        className={`w-full py-8 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all relative overflow-hidden bg-white ${
                          dragActive
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.files)
                              uploadStep3Files(Array.from(e.target.files));
                          }}
                      ...
                      {store.registrationDetails.importExportCertFiles?.length >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                          {store.registrationDetails.importExportCertFiles.map(
                            (file, idx) => (
                              <div
                                key={idx}
                                className="bg-white border border-slate-200 rounded-xl p-3 flex flex-col justify-between relative overflow-hidden shadow-sm"
                              >
                                <div className="flex items-start gap-2.5">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      const filtered =
                                        store.registrationDetails.importExportCertFiles.filter(
                                          (_, i) => i !== idx,
                                        );
                                      store.setRegistrationDetails({
                                        importExportCertFiles: filtered,
                                      });
                                    }}
                ...
                {store.currentStep === 6 && (
                  <form
                    onSubmit={handleSubmitStep4(onSaveStep4)}
                    className="space-y-6"
                  >
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-col gap-1.5">
                          ...
                          <input
                            ...
                            className="bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100/50 text-slate-800 placeholder-slate-400 shadow-sm"
                            {...registerStep4("bankName", {
                              required: "Bank Name is required",
                            })}
                          />
                          {errorsStep4.bankName && (
                            <span className="text-red-500 text-[10px]">
                              {errorsStep4.bankName.message}
                            </span>
                          )}
                          ...
                          />
                          {errorsStep4.accountNumber && (
                            <span className="text-red-550 text-[10px]">
                              {errorsStep4.accountNumber.message}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="flex flex-col gap-1.5">
                            ...
                            />
                            {errorsStep4.ifscCode && (
                              <span className="text-red-550 text-[10px]">
                                {errorsStep4.ifscCode.message}
                              </span>
                            )}
                          </div>
                          ...
                          <div className="my-2">
                            <div className="flex items-center gap-1 text-slate-400 text-xs font-mono">
                              ...
                              <span className="text-white font-bold ml-1">
                                {watchStep4("accountNumber")
                                  ? watchStep4("accountNumber").slice(-4)
                                  : "1234"}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-between items-end border-t border-white/10 pt-3">
                            <div>
                              ...
                              <p className="text-xs font-bold font-mono">
                                {watchStep4("accountType") || "SAVINGS"}
                              </p>
                            </div>
                            <div className="text-right">
                              ...
                              <p className="text-xs font-bold font-mono uppercase">
                                {watchStep4("ifscCode") || "SBIN0000000"}
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                {/* STEP 4: DOCUMENT UPLOAD CENTER */}
                {store.currentStep === 4 && (
                  <div className="space-y-6">
                    <p className="text-xs text-slate-505 text-slate-500">
                      Upload your commercial validation documents. Each section
                      represents a different compliance category.
                    </p>
                        ...
                        return (
                          ...
                          >
                            <div className="flex justify-between items-center border-b border-slate-100 pb-2">
                              <h4 className="text-xs uppercase font-extrabold tracking-widest text-blue-600 border-b border-slate-100 font-bold">
                                {cat.label}
                              </h4>
                              {totalFilesCount > 0 && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-md px-4">
          ...
          >
            <div className="flex justify-between items-start border-b border-slate-100 pb-3">
              <div>
                <h4 className="text-xs uppercase font-extrabold tracking-widest text-purple-600">
                  Security Check
                </h4>
