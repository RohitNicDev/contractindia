  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-4">
        ...
        <StatCard
          title="New"
          value={leads.filter((x) => x.status === "New").length}
        />
        <StatCard
          title="In Progress"
          value={leads.filter((x) => x.status === "In Progress").length}
        />
        <StatCard
          title="Closed"
          value={leads.filter((x) => x.status === "Closed").length}
        />
      </div>
