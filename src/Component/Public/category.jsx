          ...
          {valueItems.map((item, index) => (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background: `radial-gradient(circle at 20% 50%, ${item.glow} 0%, transparent 65%)`,
                }}
              />
              ...
              <div className="relative z-10 mt-0.5 flex-1">
                ...
                <div
                  className="mt-3 flex items-center gap-1 text-[9px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300"
