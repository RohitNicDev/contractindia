...
const ContractionAudit = () => {
  const [activeMenu, setActiveMenu] = useState("constructionaudit");
  const [openMenu, setOpenMenu] = useState("constructionaudit");
...
const auditData = {
  ...
  constructionaudit: [
    {
      id: 1,
      company: "BuildCheck Audit Consultants",
      location: "Delhi",
      experience: "12 Years",
      projects: 48,
      rating: "4.9",
      description:
        "Professional construction audit services for residential, commercial and infrastructure projects with detailed compliance reporting.",
      image:
    ...
    {
      id: 2,
      company: "Infra Audit Experts",
      location: "Mumbai",
      experience: "9 Years",
      projects: 32,
      rating: "4.7",
      description:
        "Independent project auditing and contractor performance evaluation for large-scale infrastructure works.",
      image:
  ...
  qualityverification: [
    {
      id: 1,
      company: "Quality Assure Consultants",
      location: "Bangalore",
      experience: "10 Years",
      projects: 26,
      rating: "4.8",
      description:
        "Material testing, workmanship inspection and quality verification services for ongoing construction projects.",
      image:
    ...
    {
      id: 2,
      company: "Site Quality Engineers",
      location: "Hyderabad",
      experience: "7 Years",
      projects: 18,
      rating: "4.6",
      description:
        "Third-party quality inspection and compliance reporting for civil and MEP works.",
      image:
  ...
  boqpreparation: [
    {
      id: 1,
      company: "BOQ Estimation Services",
      location: "Pune",
      experience: "11 Years",
      projects: 41,
      rating: "4.9",
      description:
        "Detailed BOQ preparation and quantity estimation services for residential and commercial projects.",
      image:
    ...
    {
      id: 2,
      company: "Cost Matrix Consultants",
      location: "Noida",
      experience: "8 Years",
      projects: 24,
      rating: "4.7",
      description:
        "Accurate project costing, BOQ generation and tender documentation support services.",
      image:
        "https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1200&auto=format&fit=crop",
    },
  ],

  /* ---------------- SITE CONSTRUCTION AUDIT ---------------- */

  siteconstructionaudit: [
    {
      id: 1,
      company: "OnSite Audit Solutions",
      location: "Raipur",
      experience: "13 Years",
      projects: 38,
      rating: "4.8",
      description:
        "Complete site construction audit including progress verification, safety checks and contractor compliance.",
      image:
    ...
    {
      id: 2,
      company: "Construction Review Experts",
      location: "Ahmedabad",
      experience: "9 Years",
      projects: 27,
      rating: "4.6",
      description:
        "Technical site inspection and audit reporting for quality, timeline and structural compliance.",
      image:
...
const menuItems = [
  {
    key: "constructionaudit",
    label: "Construction Audit",
  },

  {
    key: "qualityverification",
    label: "Verification of Quality",
  },
  ...
  {
    key: "siteconstructionaudit",
    label: "Site Construction Audit",
  },
];

  const currentData = auditData [activeMenu] || [];
...
export default ContractionAudit;
