...
const MaterialManufacture = () => {
  const [activeMenu, setActiveMenu] = useState("cementmanufacture");
  const [openMenu, setOpenMenu] = useState("cementmanufacture");

  /* ---------------- DUMMY JSON DATA ---------------- */

const materialManufactureData = {
  /* ---------------- CEMENT MANUFACTURE ---------------- */

  cementmanufacture: [
    {
      id: 1,
      company: "UltraBuild Cement Ltd.",
      location: "Chhattisgarh",
      experience: "22 Years",
      projects: 420,
      rating: "4.9",
      description:
        "Leading cement manufacturer supplying OPC, PPC and premium construction cement for infrastructure and building projects.",
      image:
    ...
    {
      id: 2,
      company: "StrongMix Cement Industries",
      location: "Rajasthan",
      experience: "18 Years",
      projects: 350,
      rating: "4.7",
      description:
        "Manufacturer of high-strength cement products for commercial, industrial and residential construction projects.",
      image:
    ...
    {
      id: 3,
      company: "Prime Cement Works",
      location: "Gujarat",
      experience: "15 Years",
      projects: 280,
      rating: "4.6",
      description:
        "Bulk cement manufacturing company specializing in sustainable and eco-friendly construction materials.",
      image:
  ...
  tilesmanufacture: [
    {
      id: 1,
      company: "Royal Tiles Studio",
      location: "Morbi, Gujarat",
      experience: "14 Years",
      projects: 260,
      rating: "4.8",
      description:
        "Premium vitrified and ceramic tile manufacturer for residential and commercial interiors.",
      image:
    ...
    {
      id: 2,
      company: "Elite Ceramic Industries",
      location: "Ahmedabad",
      experience: "11 Years",
      projects: 210,
      rating: "4.7",
      description:
        "Designer floor and wall tile manufacturing company offering modern architectural tile solutions.",
      image:
    ...
    {
      id: 3,
      company: "Modern Surface Tiles",
      location: "Delhi",
      experience: "9 Years",
      projects: 175,
      rating: "4.5",
      description:
        "High-quality tile manufacturing for luxury homes, hotels and infrastructure projects.",
      image:
  ...
  paintmanufacture: [
    {
      id: 1,
      company: "ColorCraft Paints",
      location: "Mumbai",
      experience: "20 Years",
      projects: 390,
      rating: "4.9",
      description:
        "Manufacturer of decorative, industrial and waterproof paints with premium quality finishes.",
      image:
    ...
    {
      id: 2,
      company: "BrightCoat Industries",
      location: "Pune",
      experience: "13 Years",
      projects: 240,
      rating: "4.7",
      description:
        "Advanced paint manufacturing company offering eco-friendly interior and exterior coatings.",
      image:
    ...
    {
      id: 3,
      company: "UrbanShade Paints",
      location: "Hyderabad",
      experience: "10 Years",
      projects: 190,
      rating: "4.6",
      description:
        "Specialized paint and texture manufacturer for commercial buildings and smart interior applications.",
      image:
...
const menuItems = [
  {
    key: "materialmanufacture",
    label: "Material Manufacture",
    subMenu: [
      {
        key: "cementmanufacture",
        label: "Cement Manufacture",
      },

      {
        key: "tilesmanufacture",
        label: "Tiles Manufacture",
      },

      {
        key: "paintmanufacture",
        label: "Paint Manufacture",
      },
    ],
  },
];

  const currentData = materialManufactureData [activeMenu] || [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-8">
          ...
          <aside className="space-y-4 h-fit sticky top-6">
            <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-slate-500 px-3">
             Procurement Services/ Material Manufacturing
            </p>
...
export default MaterialManufacture;
