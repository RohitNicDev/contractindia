...
const BrandDevelopment = () => {
  const [activeMenu, setActiveMenu] = useState("branddevelopment");
  const [openMenu, setOpenMenu] = useState("branddevelopment");
...
const brandDevelopmentData = {
  branddevelopment: [
    {
      id: 1,
      company: "Vision Brand Studio",
      location: "Mumbai",
      experience: "10 Years",
      projects: 120,
      rating: "4.9",
      description:
        "Complete brand identity development including logo design, brand strategy, visual guidelines and digital presence.",
      image:
    ...
    {
      id: 2,
      company: "Creative Edge Branding",
      location: "Delhi",
      experience: "8 Years",
      projects: 95,
      rating: "4.7",
      description:
        "Professional branding services for startups and enterprises with strong market positioning solutions.",
      image:
    ...
    {
      id: 3,
      company: "NextGen Brand Experts",
      location: "Bangalore",
      experience: "12 Years",
      projects: 150,
      rating: "4.8",
      description:
        "Strategic brand development and business identity solutions focused on digital and corporate branding.",
      image:
    ...
    {
      id: 4,
      company: "Urban Pixel Media",
      location: "Hyderabad",
      experience: "7 Years",
      projects: 80,
      rating: "4.6",
      description:
        "Creative branding agency specializing in social media branding, packaging and advertising campaigns.",
      image:
    ...
    {
      id: 5,
      company: "Elite Brand Works",
      location: "Pune",
      experience: "9 Years",
      projects: 102,
      rating: "4.8",
      description:
        "Modern brand consultancy providing rebranding, visual storytelling and brand communication services.",
      image:
...
const menuItems = [
  ...
  const currentData = brandDevelopmentData[activeMenu] || [];
